...
// Seleccionar solo imágenes con la clase "thumbnail2"
...
//PROYECTO CARGA INCREMENTAL Y AUDITORIA
function proyectoGitHub3() {
    window.open('https://github.com/Max-Silva-Parraguez/Project-SSIS-Incremental-Loading-and-Auditing', '_blank');
}
...
function POWER_BI_proyectoGitHub1() {
    window.open('https://github.com/Max-Silva-Parraguez/Project-POWER_BI-Credit-Portfolio-Analysis', '_blank');
}

//Cando se da clic en botón de Descarga Directa
function POWER_BI_descargarProyecto1() {
    window.open('https://github.com/Max-Silva-Parraguez/Project-POWER_BI-Credit-Portfolio-Analysis/archive/refs/heads/main.zip', '_blank');
}
